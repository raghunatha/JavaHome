...
public final static String JMS_FACTORY="jms/myQueueConnectionFactory";
public final static String QUEUE="jms/myQueue";
...
QueueMessageReciever qr = new QueueMessageReciever();
qr.init(ic, QUEUE);
